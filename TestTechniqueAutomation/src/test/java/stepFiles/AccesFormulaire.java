...
public class AccesFormulaire {
	...
	public void je_souhaite_contacter_le_service_client() throws Throwable {
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@class='header__nav__link'][contains(text(),'Aide')]")).click();
		Thread.sleep(2000);
	...
	public void je_suis_capable_de_remplir_ce_formulaire_avec_des_informations() throws Throwable {
		driver.findElement(By.xpath("//input[@placeholder='Entrez votre adresse e-mail']")).sendKeys("test@test.com");
		driver.findElement(By.xpath("//textarea[@placeholder='Veuillez rédiger votre message ici...']")).sendKeys("Mon message");
